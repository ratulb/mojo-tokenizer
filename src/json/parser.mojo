...
struct JsonParser:
    ...
    def _parse_hex(self, s: String) raises -> Int:
    ...
    def _check_slice(self, start: Int, length: Int, target: String) -> Bool:
    ...
    def skip_object(mut self) raises:
    ...
    def skip_array(mut self) raises:
    ...
    def parse_vocab_dict(mut self) raises -> Dict[String, Int]:
    ...
    def parse_merges_array(mut self) raises -> List[String]:
    ...
    def _parse_merge_pair(mut self) raises -> String:
    ...
    def find_field(mut self, field: String) raises -> Bool:
...
def parse_added_tokens(mut parser: JsonParser) raises -> List[AddedToken]:
...
def _parse_added_token(mut parser: JsonParser) raises -> AddedToken:
